...
class NoticeRepositoryImpl implements NoticeRepository{
  ...
  Future<List<Notice>> loadNews(String category, int page) async {
    final Map result = await _api.get("/sk/api/novinky/$category/$page");
  ...
  Future<List<Notice>> loadNewsRecent() async {
    final Map result = await _api.get("/sk/api/novinky/aktualne");
  ...
  Future<List<Notice>> loadSearch(String query) async {
    ...
    final Map result = await _api.get("/sk/api/hladaj/$query");
